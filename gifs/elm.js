...
Elm.Effects.make = function (_elm) {
   ...
   effect) {
      var _ = _v0;
      var combinedTask = function () {
         switch (_.ctor)
         {case "_Tuple2": return _._0;}
         _U.badCase($moduleName,
         "bugs in reporting the exact location right now");
      }();
      var intermediateResult = function () {
         switch (_.ctor)
...
Elm.RandomGif.make = function (_elm) {
   ...
   var Tick = {ctor: "Tick"};
   var tick = $Effects.task($Task.map(function (_v0) {
      return function () {
         return Tick;
      }();
   })($Task.sleep(5 * 1000)));
   ...
   var init = function (topic) {
      return {ctor: "_Tuple2"
             ...
             topic,
             "assets/waiting.gif")
             ,_1: $Effects.batch(_L.fromArray([getRandomGif(topic)
                                              ,tick]))};
   };
   ...
   model) {
      return function () {
         ...
         {case "NewGif":
            ...
            return {ctor: "_Tuple2"
                   ,_0: model
                   ,_1: $Effects.batch(_L.fromArray([getRandomGif(model.topic)
                                                    ,tick]))};}
         _U.badCase($moduleName,
